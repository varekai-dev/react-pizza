        ...
        {itemsCount ? (
          <div className="cart">
            ...
            <div className="content__items">
              {addedPizzas.map((obj) => (
                <CartItem id={obj.id} onRemoveItem={onRemoveItem} name={obj.name} type={obj.type} size={obj.size} totalPrice={items[obj.id].totalPrice} totalCount={items[obj.id].items.length} />
              ))}
            </div>
